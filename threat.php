...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if ($response === false) {
        ...
        if (isset($decodedResponse['positives'])) {
            ...
            if ($positives > 0) {
                echo "<section id='breadcrumbs' class='breadcrumbs'><h1>Threat Scanner</h1></section><section class='inner-page'><div class='container mt-5'>";
                echo "<p style='color: red'><strong>$positives security vendor(s) flagged this URL as malicious.</strong></p>";
                echo "</div><section>";
                $showForm = false;
            } else {
                echo "<section id='breadcrumbs' class='breadcrumbs'><h1>Threat Intelligence Program</h1></section><section class='inner-page'><div class='container mt-5'>";
...
<body>
  ...
  <div class="container-1">
        ...
        <form action="threat-results.php" method="post">
            <div class="form-group">
                <label class="form-label" for="accesskey">Enter URL to check:</label>
                <input type="text" class="form-control" id="urlInput" name="urlInput" required>
            </div>
            <!-- <div class="form-group">
                <div class="g-recaptcha" data-sitekey="6LeQCVAoAAAAAMvOTGLvEMImYHmIVECW8w4Q3Lyt"></div>
            </div> -->
            <button type="submit" name="submit" class="btn btn-primary">Check Safety</button>
        </form>
