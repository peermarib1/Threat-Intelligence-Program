...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php">GDC GBL</a></h1>
  ...
  <div class="container-1">
        <h2 class="form-heading">File Scanner</h2>
        
        <form action="scan.php" method="post" enctype="multipart/form-data">
  <input type="file" name="fileToScan" class="fileinput" required>
  <br>
  <input type="submit" class="btn btn-primary" value="Scan File" name="submit">
</form>
